...
class Credit(SQLitedb):
    ...
    def post_credit(
        self, name_bd, credit_card_number, credit_card_expiration_date, cvv, user_id
    ):
        table = SQLitedb()
        table.connect(name_bd)
        sql = (
            f"INSERT INTO Credit(credit_card_number,credit_card_expiration_date,cvv,user_id)"
...
class Server:
    ...
    def post_credit(
        self, bd, credit_card_number, credit_card_expiration_date, cvv, user_id
    ):
        bd.connect(self.name_bd)
        bd.post_credit(
            self.name_bd, credit_card_number, credit_card_expiration_date, cvv, user_id
